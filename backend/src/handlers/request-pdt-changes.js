...
/**
 * POST /pdt/{pdtId}/request-changes
 * Supervisor requests changes on a PDT record.
 * Body: { comments: string }
 * Transitions PENDING_APPROVAL → CHANGES_REQUESTED and records supervisor comments.
 */
